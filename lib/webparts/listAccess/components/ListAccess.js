...
import styles from './ListAccess.module.scss';
...
var ListAccess = /** @class */ (function (_super) {
    ...
    ListAccess.prototype.render = function () {
        ...
        return (React.createElement("section", { className: "".concat(styles.listAccess, " ").concat(hasTeamsContext ? styles.teams : '') },
...
//# sourceMappingURL=ListAccess.js.map